...
SCREENSHOTS_PATH=/home/coder/screenshots
...
function startWindsurf() {
    ...
    cp /home/coder/entry-workflow.md $WORKSPACE_WORKFLOWS_PATH
    log "Starting Windsurf editor at DISPLAY=$DISPLAY"
    #windsurf --no-sandbox --user-data-dir /home/coder &
